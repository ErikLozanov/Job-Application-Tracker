...
const JobDetails = () => {
    ...
    const handleGeneratePrep = () => {
        generateInterview(id!, {
            onSuccess: (data) => setInterviewPrep(data.interviewPrep),
        });
    };

    if (isLoading)
        return (
            <div className="flex h-64 items-center justify-center text-blue-600 font-medium animate-pulse">
                Loading details...
            </div>
        );
    if (isError || !job)
        ...
        <div className="max-w-5xl mx-auto space-y-6 pb-20">
                    ...
                    <div className="flex-1 space-y-4">
                        ...
                        {!isEditing && (
                            <div className="flex flex-wrap items-center gap-3 pt-1">
                                ...
                                <span
                                    className={`px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full bg-gray-100 text-gray-600 border border-gray-200`}
                                >
                        ...
                        {isEditing ? (
                            <>
                                <button
                                    ...
                                    className="px-4 py-2 rounded-xl bg-white border border-gray-200 text-gray-700 font-medium hover:bg-gray-50 transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
                                    onClick={handleSave}
                                    disabled={isSaving}
                                    className="px-6 py-2 rounded-xl bg-blue-600 text-white font-bold shadow-lg shadow-blue-500/30 hover:bg-blue-700 hover:-translate-y-0.5 transition-all disabled:opacity-50"
                                >
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 rounded-xl bg-blue-50 text-blue-700 font-bold hover:bg-blue-100 transition-colors border border-blue-100"
                                >
                                    Edit
                                </button>
                                <button
                                    ...
                                    disabled={isDeleting}
                                    className="px-4 py-2 rounded-xl bg-red-50 text-red-700 font-bold hover:bg-red-100 transition-colors border border-red-100"
                                >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={handleChange}
                                        className="block w-full rounded-lg border-gray-300 bg-gray-50 p-2.5 text-sm focus:ring-blue-500 focus:border-blue-500"
                                    >
                ...
                <div className="space-y-6">
                    ...
                    {!isEditing &&
                        (job.resumeUrl ? (
                            ...
                            <div className="bg-amber-50 rounded-2xl shadow-sm border border-amber-200 p-6 relative overflow-hidden">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-amber-700 mt-1">
                                            For better AI results, attach the
                                            resume you used for this
                                            application.
                                        </p>
                                    </div>
                                </div>
                                <button
                                    onClick={() => setIsEditing(true)}
                                    className="mt-4 w-full py-2 text-xs font-bold text-amber-800 bg-amber-100 hover:bg-amber-200 rounded-lg transition-colors"
                                >
                                    Upload Resume
                                </button>
                            </div>
                    ...
                    <div className="bg-gradient-to-b from-indigo-50 to-white rounded-2xl shadow-sm border border-indigo-100 p-6 overflow-hidden relative">
                        ...
                        <p className="text-sm text-indigo-600/80 mb-6 leading-relaxed">
                            {job.resumeUrl
                                ? "AI will use your attached resume and notes to create a tailored cover letter."
                                : "Add a resume for a more personalized cover letter result."}
                        </p>
                        {!generatedLetter ? (
                            <button
                            ...
                            <div className="space-y-3 animate-fade-in">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="flex-1 py-2 text-xs font-bold text-gray-500 hover:text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200"
                                    >
                                        Discard
                                    </button>
                                    <button
                    ...
                    <div className="bg-gradient-to-b from-emerald-50 to-white rounded-2xl shadow-sm border border-emerald-100 p-6 overflow-hidden relative mt-6">
            ...
            {!interviewPrep ? (
              <button
                ...
                className="w-full py-3 rounded-xl bg-emerald-600 text-white font-bold shadow-lg shadow-emerald-500/30 hover:bg-emerald-700 hover:-translate-y-0.5 transition-all disabled:opacity-50"
              >
                {isPrepLoading ? (
                  <span className="flex items-center justify-center gap-2">
              ...
              <div className="space-y-3 animate-fade-in">
                <div className="w-full h-96 overflow-y-auto text-sm text-gray-700 bg-white border border-emerald-100 rounded-lg p-4 leading-relaxed prose prose-sm prose-emerald">
                  <pre className="whitespace-pre-wrap font-sans">{interviewPrep}</pre>
                </div>
                <div className="flex gap-2">
                  <button onClick={() => setInterviewPrep('')} className="flex-1 py-2 text-xs font-bold text-gray-500 hover:text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
                    Close
                  </button>
                  <button 
                    onClick={() => { navigator.clipboard.writeText(interviewPrep); alert('Copied!'); }} 
                    className="flex-1 py-2 text-xs font-bold text-emerald-700 bg-emerald-100 rounded-lg hover:bg-emerald-200 border border-emerald-200"
                  >
                    Copy to Clipboard
                  </button>
                </div>
