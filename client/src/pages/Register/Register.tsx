    ...
    <div className="min-h-screen flex">
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center bg-white px-8 py-12 lg:px-24">
        <div className="w-full max-w-sm">
          <Link to="/" className="text-2xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 mb-8 block">
            JobTracker
          </Link>

          <h2 className="text-3xl font-bold text-gray-900 mb-2">Create Account</h2>
          <p className="text-gray-500 mb-8">Start your journey to your dream career.</p>
      ...
      <div className="hidden md:flex md:w-1/2 bg-gray-900 relative overflow-hidden items-center justify-center p-12">
        <div className="absolute inset-0 bg-gradient-to-bl from-indigo-900 via-purple-900 to-blue-900 opacity-90" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-indigo-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob" />
        
        <div className="relative z-10 text-white max-w-lg text-center">
          <h2 className="text-4xl font-bold mb-6">Join the community.</h2>
          <p className="text-lg text-indigo-100 leading-relaxed">
            "Organize applications. Track interviews. Your career upgrade starts right here, right now."
          </p>
        </div>
      </div>
    </div>
